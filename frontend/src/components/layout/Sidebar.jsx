...
import { UserRound, CalendarDays, Files, ReceiptText, FileClock } from "lucide-react"
import logo from "../../assets/screen.png"

const menuItems = [
  { name: "Profil", icon: UserRound, href: "/profile" },
  { name: "Congés", icon: CalendarDays, href: "/leaves" },
  { name: "Documents", icon: Files, href: "/documents" },
  { name: "Bulletins", icon: ReceiptText, href: "/payslips" },
  { name: "Demandes", icon: FileClock, href: "/requests" },
]
    ...
    <aside className="sticky top-0 flex h-screen w-[260px] shrink-0 flex-col border-r border-[#E3E8F2] bg-white">
      ...
      <div className="flex min-h-[120px] items-center border-b border-[#E3E8F2] px-6">
        <div className="flex items-center gap-3">
          <img src={logo} alt="WAMA RH" className="h-16 w-16 rounded-xl object-contain" />
          <div>
            <p className="text-xl font-bold tracking-tight text-[#0F2B68]">WAMA RH</p>
      ...
      <div className="border-t border-[#E3E8F2] p-4">
        <div className="rounded-2xl border border-[#E4EAF5] bg-[#F7F9FD] p-4">
          <p className="text-sm font-bold text-[#0F2B68]">WAMA RH</p>
